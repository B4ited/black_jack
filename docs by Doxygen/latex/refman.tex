...
{\Large Black\+\_\+jack }\\
\vspace*{1cm}
{\large Készítette Doxygen 1.8.20}\\
\end{center}
\end{titlepage}
...
\input{namespacerft__8__het__black__jack}
\chapter{Osztályok dokumentációja}
\input{classrft__8__het__black__jack_1_1_app}
\input{classrft__8__het__black__jack_1_1_main__game}
\input{classrft__8__het__black__jack_1_1_player}
\chapter{Fájlok dokumentációja}
\input{_app_8java}
\input{black__jack__test_8java}
\input{_main__game_8java}
\input{_player_8java}
